...
function init() {
  ...
  function gotData(data){
   ...
   t1.text = formatString(answer1[questionIndex], "A)");
   t2.text = formatString(answer2[questionIndex], "B)");
   t3.text = formatString(answer3[questionIndex], "C)");
   t4.text = formatString(answer4[questionIndex], "D)");
   t5.text = formatString(question1[questionIndex], "Q)");
...
for(var i = 0; i < str.length; i++){
  if((i - 18) == num){
    newString = newString +  str.substr(num, 18) + " \n ";
    num = i;
  }
 
  }
  if(num < str.length){
    newString = "\n" + newString + str.substr(num, str.length);
  }
...
function createBackGround() {
  ...
  qWrongText.y = 260;
   ...
   shape1.graphics.beginFill("green").drawRect(180,0,180, 200);
  
    shape2 = new createjs.Shape();
   shape2.graphics.beginFill("yellow").drawRect(360,0,180, 200);

    shape3 = new createjs.Shape();
   shape3.graphics.beginFill("yellow").drawRect(540,0,180, 200);

    shape4 = new createjs.Shape();
   shape4.graphics.beginFill("yellow").drawRect(720,0,180, 200);
   shape5 = new createjs.Shape();
   shape5.graphics.beginFill("yellow").drawRect(0,0,180, 200);
  ...
  t3.x = 540;
   ...
   stage2.addChild(shape1, shape2, shape3, shape4, shape5, t1, t2, t3, t4, t5);
...
function changeColor(cxc) {
  switch (cxc) {
    ...
    case 360:
      a2.color = "green";
      shape2.graphics.beginFill("green").drawRect(360,0,180, 200);
      correctColor(a2.x);
      break;
    case 490:
      a3.color = "green";
      shape3.graphics.beginFill("green").drawRect(540,0,180, 200);
      correctColor(a3.x);
      break;
    case 610:
      a4.color = "green";
      shape4.graphics.beginFill("green").drawRect(720,0,180, 200);
      correctColor(a4.x);
      break;
...
function correctColor(textPos) {
  if (textPos == 210) {
    ...
    if (a1.color == "green") {
      a1.color = "yellow";
      shape1.graphics.beginFill("yellow").drawRect(180,0,180, 200);
    }
    else {
      a3.color = "yellow";
      shape3.graphics.beginFill("yellow").drawRect(540,0,180, 200);
